    ...
    */
    ...
    'connections' => [
        ...
        'tidb' => [
            ...
            'port' => env('TIDB_PORT', env('DB_PORT', '4000')),
            'database' => env('TIDB_DATABASE', env('DB_DATABASE', 'laravel')),
            'username' => env('TIDB_USERNAME', env('DB_USERNAME', 'root')),
            'password' => env('TIDB_PASSWORD', env('DB_PASSWORD', '')),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => env('DB_CHARSET', 'utf8mb4'),
            'collation' => env('DB_COLLATION', 'utf8mb4_unicode_ci'),
            'prefix' => '',
